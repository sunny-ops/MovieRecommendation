...
public class SitDownRestaurantsDao extends RestaurantsDao {
	...
	public SitDownRestaurants create(SitDownRestaurants sitdownRestaurants) throws SQLException {
		// Insert into the superclass table first.
//		create(new Restaurants(sitdownRestaurants.getRestaurantId(), sitdownRestaurants.getName(), sitdownRestaurants.getDescription(), sitdownRestaurants.getMenu(),
//				sitdownRestaurants.getHours(), sitdownRestaurants.getActive(), sitdownRestaurants.getCuisine(),sitdownRestaurants.getStreet1(), sitdownRestaurants.getStreet2(),
//				sitdownRestaurants.getCity(), sitdownRestaurants.getState(), sitdownRestaurants.getZip(), sitdownRestaurants.getCompanyName()));
		...
		try {
			...
			insertStmt.setInt(1, sitdownRestaurants.getRestaurantId());
			insertStmt.setInt(2, sitdownRestaurants.getCapacity());
...
//	 */
	public SitDownRestaurants delete(Restaurants restaurant) throws SQLException {
...
//
	public SitDownRestaurants getSitDownRestaurantById(int sitDownRestaurantId) throws SQLException {
		String selectRestaurant =
				"SELECT SitDownRestaurant.RestaurantId AS RestaurantId, SitDownRestaurant.Capacity AS Capacity, Name, Description, Menu, Hours, Active, CuisineType, Street1, Street2, City, State, Zip, CompanyName" +
		...
		try {
			...
			if(results.next()) {
				...
				SitDownRestaurants sitdownRestaurant = new SitDownRestaurants(resultRestaurantId, capacity, name, description, menu, hours, active, cuisineType, street1, street2, city, state, zip, companyName);
	...
	public List<SitDownRestaurants> getSitDownRestaurantsByCompanyName(String companyName)
		...
		try {
			...
			while(results.next()) {
				...
				SitDownRestaurants sitdownRestaurant = new SitDownRestaurants(restaurantId, capacity, name, description, menu, hours, active, cuisineType, street1, street2, city, state, zip, resultCompanyName);
